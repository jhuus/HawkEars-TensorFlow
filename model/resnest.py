...
class ResNest:
    ...
    def __init__(self, num_classes=3, input_shape=(80, 384, 1), active='swish', dropout_rate=0.5,
    ...
    def build_model(self, class_act):
        ...
        fc_out = Dense(self.num_classes, activation=class_act, kernel_initializer=self.initializer, use_bias=False, dtype='float32', name='fc_NObias')(x)
